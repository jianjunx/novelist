...
func SetupRouter(r *gin.Engine) {
	...
	protected.Use(auth.AuthMiddleware())
	{
		...
		projects.POST("/:id/chapters/batch-delete", BatchDeleteChapters)
			projects.POST("/:id/chapters/reorder", ReorderChapters)
		...
		protected.POST("/chapters/:id/manual-revise", ManualReviseChapter)
		...
		protected.POST("/chapters/:id/apply-feedback", ApplyFeedback)
